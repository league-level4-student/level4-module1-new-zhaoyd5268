...
class Dog extends Animal {
    ...
    public void eat() {
    	System.out.println("I Love eating Ziwi Good dog rewards treats! They taste so good! im eating them right now!");
    }
}
...
class Bird extends Animal {
    ...
    public void eat() {
    	System.out.println("I Love eating Black oil sunflower seeds. Im eating them right now!");
    }
}
...
class Fish extends Animal {
    ...
    public void eat() {
    	System.out.println("I love my earthworms. They taste so good! Im eating them right now!");
    }
